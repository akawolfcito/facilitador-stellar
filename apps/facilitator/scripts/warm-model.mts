 ...
 *
 * Calls the real embedder rather than fetching the files directly, so if an
 * artifact path or revision ever moves the build fails here instead of the
 * container failing at boot.
 */

import { EMBEDDING_MODEL, embed } from "@stellar-bazaar/search";
